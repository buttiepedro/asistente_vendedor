...
export default function TablaEmpresas({empresas, error, loading, onUpdate, onEliminar}) {
  ...
  return (
          ...
          <tr key={e.id} className="animate-fade-down animate-duration-300">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
              <span className="flex items-center gap-2">
                  <p className={`${e.web_hook_url ? 'text-gray-500' : 'text-red-600'} truncate max-w-3xs`}>
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
              <span className="flex items-center gap-2">
                <p className={`${e.looker_url ? 'text-gray-500' : 'text-red-600'} truncate max-w-3xs`}>
                  {e.looker_url || "No configurado"}
                </p>
              <span className="cursor-pointer" onClick={() => {setOnClipBoard(e.looker_url)}}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" strokeWidth={1.5} stroke="currentColor" className="size-6 hover:text-sky-900">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0 0 15 2.25h-1.5a2.251 2.251 0 0 0-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 0 0-9-9Z" />
                </svg>
              </span>
            ...
            <td className="px-6 py-4 whitespace-nowrap text-right text-sm  font-medium">
              ...
              <button onClick={() => {setShowModal(true),setEmpresaEliminar(e.id)}} className="text-red-600 hover:text-red-900 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
    ...
    <ConfirmationModal 
      ...
      onConfirm={() => onEliminar(empresaEliminar)}
