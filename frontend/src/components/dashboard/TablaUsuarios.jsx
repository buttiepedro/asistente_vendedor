...
export default function TablaUsuarios({usuarios, error, loading, onEliminar, onUpdate}){
  ...
  return (
        ...
        {!loading && !error && usuarios.map((e) => (
          <tr key={e.id} className="animate-fade-down animate-duration-300">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-right text-sm  font-medium">
              ...
              <button onClick={() => (setShowModal(true),setUsuarioEliminar(e.id))} className="text-red-600 hover:text-red-900 cursor-pointer">
    ...
    <ConfirmationModal 
      ...
      onConfirm={() => onEliminar(usuarioEliminar)}
